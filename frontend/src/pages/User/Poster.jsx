  ...
  return user ? (
    <div className="w-full">
      ...
      <div className="big flex flex-col dark:bg-black dark:text-black bg-white text-black">
        ...
        >
          <img src={user.coverImg} className="absolute top-0 left-0 right-0 bottom-0 object-fill" />
          <div
            className="pp h-24 absolute w-24 rounded-full translate-y-36 ml-4 border border-white !bg-cover bg-black"
          >
                        <img src={user.pp} className="absolute top-0 left-0 right-0 bottom-0 object-fill rounded-full" />
          </div>
        </div>
