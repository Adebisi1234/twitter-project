const Header = ({ title, text }) => {
  return (
    <header
      className="w-full flex h-12 p-2 mt-2 dark:bg-black dark:text-white bg-white text-black items-center gap-3 justify-between"
      onClick={() => {
        document.getElementById("slide").classList.toggle("-translate-x-full");
      }}
    >
